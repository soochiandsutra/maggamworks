...
interface AppState {
  ...
  setFrontHasBorders: (has: boolean | null) => void;
  setFrontBorderSize: (size: number | null) => void;
  setFrontHasBlouseBottom: (has: boolean | null) => void;
  setFrontBlouseBottomSize: (size: number | null) => void;
  setFrontNeckStyle: (style: string) => void;
  setFrontHasFillWork: (has: boolean | null) => void;
  setFrontCoverage: (coverage: number | null) => void;
  setFrontHasMotifs: (has: boolean | null) => void;
  setFrontMotifSizeX: (size: number | null) => void;
  setFrontMotifSizeY: (size: number | null) => void;
  setFrontMotifCount: (count: string | null) => void;
  setFrontSelectedTechniques: (techniques: string[] | null) => void;
  setFrontTechniquePercentages: (percentages: Record<string, number> | null) => void;

  setBackHasBorders: (has: boolean | null) => void;
  setBackBorderSize: (size: number | null) => void;
  setBackHasBlouseBottom: (has: boolean | null) => void;
  setBackBlouseBottomSize: (size: number | null) => void;
  setBackNeckStyle: (style: string) => void;
  setBackHasFillWork: (has: boolean | null) => void;
  setBackCoverage: (coverage: number | null) => void;
  setBackHasMotifs: (has: boolean | null) => void;
  setBackMotifSizeX: (size: number | null) => void;
  setBackMotifSizeY: (size: number | null) => void;
  setBackMotifCount: (count: string | null) => void;
  setBackSelectedTechniques: (techniques: string[] | null) => void;
  setBackTechniquePercentages: (percentages: Record<string, number> | null) => void;

  setHandsHasBorders: (has: boolean | null) => void;
  setHandsBorderSize: (size: number | null) => void;
  setHandsNeckStyle: (style: string) => void;
  setHandsSelectedDesign: (design: string) => void;
  setHandsHasFillWork: (has: boolean | null) => void;
  setHandsCoverage: (coverage: number | null) => void;
  setHandsHasMotifs: (has: boolean | null) => void;
  setHandsMotifSizeX: (size: number | null) => void;
  setHandsMotifSizeY: (size: number | null) => void;
  setHandsMotifCount: (count: string | null) => void;
  setHandsSelectedTechniques: (techniques: string[] | null) => void;
  setHandsTechniquePercentages: (percentages: Record<string, number> | null) => void;

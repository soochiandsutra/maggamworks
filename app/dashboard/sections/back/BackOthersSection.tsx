  ...
  return (
    <div className="grid gap-4">
      <h3 className="font-semibold mb-3 flex items-center gap-2 text-base">
        <span className="text-primary">🔧</span> Back Embroidery Techniques
      </h3>
                ...
                <Card key={technique.id} className="relative cursor-pointer p-4 ring-1 border-border ring-border/30 hover:border-primary/30 hover:bg-primary/2 transition-all">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      <Label htmlFor={`back-${technique.id}`} className="text-sm font-medium cursor-pointer">
                        {technique.name}
                      </Label>
                    </div>
                  </div>
